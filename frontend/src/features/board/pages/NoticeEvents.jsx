/**
 * ============================================================================
 * NoticeEvents.jsx - 공지사항/이벤트 페이지
 * ============================================================================
 *
 * 【목적】
 * - 고객센터 공지사항 및 이벤트 정보 제공
 * - 탭 전환 및 검색 기능 제공
 *
 * 【주요 기능】
 * 1. **탭 전환**: 이벤트 ↔ 공지사항 탭
 * 2. **검색 기능**: 제목/설명 필터링 (실시간 검색)
 * 3. **이벤트 카드 그리드**: 이미지, 제목, 설명, 배지 표시
 * 4. **공지사항 테이블**: 번호, 제목, 등록일 표시
 * 5. **빈 상태 처리**: 검색 결과 없을 시 안내 메시지
 *
 * 【데이터 구조】
 * ```javascript
 * // 이벤트
 * { id, img, title, desc, badge }
 *
 * // 공지사항
 * { id, title, date }
 * ```
