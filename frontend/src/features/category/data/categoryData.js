/**
 * ============================================================================
 * categoryData.js - 카테고리 메타 데이터
 * ============================================================================
 *
 * 【목적】
 * - 카테고리별 메타 정보 (이름, 영문명, 총 상품 개수)
 * - 서브카테고리 탭 정보 (이름, 경로, 개수)
 * - 페이지별 설정 (제목, 상품 개수)
 *
 * 【사용처】
 * - CategoryPage.jsx: 카테고리 페이지 렌더링 시 메타 정보 참조
 * - Header/NavBar: 카테고리 메뉴 생성
 *
 * 【데이터 구조】
 * ```javascript
 * CATEGORY_DATA = {
 ...
 *
 * 【카테고리 목록】
 * - women: 여성 (아우터, 재킷, 니트, 셔츠, 티셔츠, 원피스, 팬츠, 스커트 등)
 * - men: 남성 (정장, 재킷, 셔츠, 니트, 티셔츠, 팬츠 등)
 * - kids: 키즈 (남아, 여아, 베이비 등)
 * - sports: 스포츠 (아웃도어, 러닝, 요가, 피트니스, 테니스, 수영 등)
 * - beauty: 뷰티 (스킨케어, 메이크업, 향수 등)
 * - golf: 골프 (여성, 남성)
 * - luxury: 럭셔리 (여성, 남성)
 * - shoes: 백&슈즈 (여성, 남성)
 * - life: 라이프 (가구/인테리어, 반려동물, 자동차 등)
 * - outlet: 아울렛 (여성, 남성, 키즈, 럭셔리, 슈즈, 스포츠, 골프, 라이프)
 *
 * @module categoryData
 * @author Claude Code
 * @since 2025-11-02
