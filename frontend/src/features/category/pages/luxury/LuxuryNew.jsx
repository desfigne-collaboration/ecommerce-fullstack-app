...
function LuxuryNew() {
  const products = [
    ...
    { id: 5, name: "", desc: "", price: "", img: "https://desfigne.synology.me/data/image/thejoeun/products/luxury_new5.webp" },
    { id: 6, name: "", desc: "", price: "", img: "https://desfigne.synology.me/data/image/thejoeun/products/luxury_new6.webp" },
  ];
